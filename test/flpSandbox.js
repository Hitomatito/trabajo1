		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Master Detail",
									"targetURL": "#masterdetail2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"masterdetail2-display": {
								"semanticObject": "masterdetail2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=masterdetail2",
									"url": sap.ui.require.toUrl("masterdetail2")
								}
							}
						}
					}
